	...
	<form action="" method="POST" enctype = "multipart/form-data">
		<div class = "row">
			<?php
				...
				$komut = $baglanti->prepare("select adi,markasi,modeli,rengi,satis_fiyati,resim from aracbiriki,a1600mresim where aracbiriki.16_id = a1600mresim.16_id and aracbiriki.akategori_id = 9 group by aracbiriki.16_id");
				$komut->execute();
