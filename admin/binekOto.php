...
if (isset($_POST['12_Ekle']))
{
  ...
  */
  ...
  if($sonuc = $komut->fetch(PDO::FETCH_ASSOC))
    ...
    $baglanti->query("insert into aracBirIki(a12_ad,a12_markasi,aKategori_id,alis_fiyati,satis_fiyati) values('$a12_ad','$a12_markasi','$aKategori_id','$alis_fiyati','$satis_fiyati')");
 ...
 ?>
    ...
    <div class="col-sm-1 form-group">
      <input type="text" class="form-control" name="24">
                      ...
                      <div class="form-group">
                        <button type="submit" class="form-control bg-danger text-white col-sm-2" name="16_Ekle">1.6 Araç Ekle</button>
                      </div>
                  </form>
              </div><br>
