...
$komut = $baglanti->prepare("select aracbiriki.12_id,markasi,resim from aracbiriki,1200mresim where aracbiriki.12_id = 1200mresim.12_id and aracbiriki.kategori_id = 2 and aracbiriki.12_id ='$a_id'");
$komut->execute();
...
<div class = "parent-container">
	<div class = "row">
		<div class = "col-sm-9">
			<div class ="container">
				<form action="" method="POST" enctype = "multipart/form-data">
					<div class = "row">
						<?php
							$komut = $baglanti->prepare("select adi,satis_fiyati,resim from aracbiriki,a1200mresim where aracbiriki.12_id = a1200mresim.12_id and aracbiriki.akategori_id = 9 and aracbiriki.12_id ='$a_id'");
							$komut->execute();
		...
		<div class = "col-sm-3">
			<div class="container ">
				<form action = "" method = "POST" enctype = "multipart/form-data">
					...
					<?php
							$komut = $baglanti->prepare("select adi,markasi,modeli,rengi from aracbiriki where 12_id = '$a_id'");
							$komut->execute();
							while($sonuc=$komut->fetch(PDO::FETCH_BOTH))
							{?>
		...
		<div class ="row" >
				...
				<button type = "submit" name ="44" class ="btn  bg-info form-control col-sm-2 ml-3">2010</button>
	...
	<div class ="row">
		...
		for($i=44;$i<=56;$i=$i+2)
		{
			if(isset($_POST[$i]))
			{
				...
				{
					$komut=$baglanti->prepare("select aracs from aracbiriki,araca where aracbiriki.12_id = araca.12_id and aracbiriki.12_id ='$id_degeri' and arac_a ='$i' and arac_cins = 'binek'");
					$komut->execute();
				...
				{
					$komut=$baglanti->prepare("select aracs from aracbiriki,araca where aracbiriki.12_id = araca.12_id and aracbiriki.12_id ='$id_degeri' and arac_a ='$i' and arac_cins = 'ticari'");
										$komut->execute();
				...
				{
					$komut=$baglanti->prepare("select aracs from aracbiriki,araca where aracbiriki.12_id = araca.12_id and aracbiriki.12_id ='$id_degeri' and arac_a ='$i' and arac_cins = 'suv'");
										$komut->execute();
